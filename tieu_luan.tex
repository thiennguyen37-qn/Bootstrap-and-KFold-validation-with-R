...
Bệnh gan tiến triển âm thầm trong nhiều năm trước khi xuất hiện triệu chứng
rõ rệt, và đến khi đó khả năng can thiệp đã thu hẹp đáng kể. Việc sàng lọc
sớm dựa trên các chỉ số sinh hoá thường quy như bilirubin, men gan và
albumin vì vậy mang ý nghĩa thực tiễn lớn. Bộ dữ liệu \emph{Indian Liver
Patient Dataset} (ILPD) ghi lại những chỉ số này cùng chẩn đoán xác định
của 583 bệnh nhân, đặt ra một bài toán phân loại nhị phân: dự đoán tình
trạng mắc bệnh gan từ kết quả xét nghiệm.

Nếu chỉ dừng ở việc khớp một mô hình rồi công bố một giá trị độ chính xác,
bài toán chưa được giải quyết trọn vẹn. Giá trị ấy được tính trên một mẫu
hữu hạn và sẽ thay đổi nếu quan sát một nhóm bệnh nhân khác. Hai câu hỏi
cần được trả lời là:

\begin{enumerate}
  \item Trong các cấu hình mô hình có thể xây dựng, cấu hình nào cho khả
        năng dự đoán tốt nhất trên dữ liệu chưa từng quan sát? Câu hỏi này
        đòi hỏi một cơ chế đánh giá khách quan, bảo đảm dữ liệu kiểm tra
        không tham gia vào quá trình lựa chọn. Đó là vai trò của K-fold
        Cross-Validation.
  \item Mô hình được chọn có độ tin cậy đến đâu? Hiệu năng công bố là một
        ước lượng điểm, cần được bổ sung khoảng tin cậy để phản ánh mức dao
        động của nó. Đó là vai trò của Bootstrap.
\end{enumerate}

Nói ngắn gọn, K-fold Cross-Validation phục vụ việc lựa chọn mô hình, còn
Bootstrap phục vụ việc định lượng độ tin cậy của mô hình đã chọn. Báo cáo
trình bày cơ sở lý thuyết của hai phương pháp, sau đó áp dụng chúng vào một
quy trình hoàn chỉnh trên bộ dữ liệu ILPD, từ tiền xử lý và lựa chọn biến
cho tới tinh chỉnh siêu tham số, lựa chọn ngưỡng phân loại và ước lượng
khoảng tin cậy cho hiệu năng cuối cùng.
